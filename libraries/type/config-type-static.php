...
$config['static'][$nametype]['width'] = 423;
$config['static'][$nametype]['height'] = 376;
$config['static'][$nametype]['width1'] = 423;
$config['static'][$nametype]['height1'] = 376;
$config['static'][$nametype]['width2'] = 423;
$config['static'][$nametype]['height2'] = 376;
...
/* Slogan giới thiệu */
$nametype = "slogan-gioi-thieu";
$config['static'][$nametype]['title_main'] = "Slogan giới thiệu";
$config['static'][$nametype]['check'] = array("hienthi" => "Hiển thị");
$config['static'][$nametype]['name'] = true;
