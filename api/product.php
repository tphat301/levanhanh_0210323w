...
<?php if ($countItems) { ?>
    <div class="flex-cus row">
        <?php foreach ($items as $k => $v) { ?>
            <div class="col-6 col-sm-6 col-md-4 col-lg-3 p22 mb-3">
                <div class="box-product" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div class="bx_info_pro">
                        ...
                        <p class="price-product">
                            <?php if ($v['discount']) { ?>
                                <span class="price-new"><?= $func->formatMoney($v['sale_price']) ?></span><span class="price-old">- <?= $func->formatMoney($v['regular_price']) ?></span>
